<?php
class ControllerRevolutionRevlanguage extends Controller {
	public function index() {
		$this->load->language('common/language');
		
		$data['text_language'] = $this->language->get('text_language');

		$data['action'] = $this->url->link('revolution/revlanguage/language', '', $this->request->server['HTTPS']);
		...
		return $this->load->view('revolution/revlanguage', $data);
	}
