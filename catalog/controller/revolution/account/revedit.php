...
class ControllerRevolutionAccountRevEdit extends Controller {
	...
	public function index() {
		...
		$custom_fields_addrs = $this->model_account_custom_field->getCustomFields($this->config->get('config_customer_group_id'));
		foreach ($custom_fields_addrs as $custom_field) {
			if ($custom_field['location'] == 'address') {
				$data['custom_fields_addr'][] = $custom_field;
			}
		}
