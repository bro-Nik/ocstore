...
class ControllerExtensionModuleRevmenumod extends Controller {
	public function index() {
		...
		$data['setting_revtheme_header_menu'] = $setting = $this->config->get('module_revmenumod');
		...
		$results_amazon_links = $this->config->get('module_revmenumod_link');
		...
		$revtheme_dop_menu = $this->config->get('module_revmenumod_link_dop');
		...
		if ($setting_shab['type']) {
			...
			return $this->load->view('extension/module/revmenumod', $data);
		}
	}
}
