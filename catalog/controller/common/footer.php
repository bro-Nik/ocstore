...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$revtheme_dop_menu_callbtn = $this->config->get('revtheme_dop_menu_callbtn');
		if (!empty($revtheme_dop_menu_callbtn)){
			$data['revtheme_dop_menus_callbtn'] = json_decode(htmlspecialchars_decode($revtheme_dop_menu_callbtn), true);
			foreach($data['revtheme_dop_menus_callbtn'] as $key => $val){
				if (!empty($data['revtheme_dop_menus_callbtn'][$key]['dop_menu_image_callbtn'])){
					$data['revtheme_dop_menus_callbtn'][$key]['dop_menu_image_callbtn'] = $this->model_tool_image->resize($data['revtheme_dop_menus_callbtn'][$key]['dop_menu_image_callbtn'], $img_cf_wh, $img_cf_wh);
				} else {
					$data['revtheme_dop_menus_callbtn'][$key]['dop_menu_image_callbtn'] = false;
				}
			}
		} else {
			$data['revtheme_dop_menus_callbtn'] = false;
		}
		// Revolution End
