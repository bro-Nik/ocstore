...
class ControllerExtensionModuleRevmenumodcustom extends Controller {
	...
	public function index() {
		$this->load->language('extension/module/revmenumodcustom');
		...
		if (isset($this->request->post['links'])) {
			...
			$data['links'] = htmlspecialchars_decode(addslashes($module_info['links']));
		} else {
			$data['links'] = '[]';
		}
		...
		$this->response->setOutput($this->load->view('extension/module/revmenumodcustom', $data));
