...
class ControllerRevolutionRevstorereview extends Controller {
    ...
    public function index() {
		...
		if ($settings_all_settings['otzivy_status']) {
			...
			if ($this->config->get('revtheme_meta')['otz_meta_title'][(int)$this->config->get('config_language_id')]) {
				$this->document->setTitle($this->config->get('revtheme_meta')['otz_meta_title'][(int)$this->config->get('config_language_id')]);
			} else {
				$this->document->setTitle($data['heading_title']);
			}
			if ($this->config->get('revtheme_meta')['otz_meta_description'][(int)$this->config->get('config_language_id')]) {
				$this->document->setDescription($this->config->get('revtheme_meta')['otz_meta_description'][(int)$this->config->get('config_language_id')]);
			}
			if ($this->config->get('revtheme_meta')['otz_meta_keyword'][(int)$this->config->get('config_language_id')]) {
				$this->document->setKeywords($this->config->get('revtheme_meta')['otz_meta_keyword'][(int)$this->config->get('config_language_id')]);
			}
