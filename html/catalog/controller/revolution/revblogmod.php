...
class ControllerRevolutionRevblogmod extends Controller {
	public function index() {
		...
		$data['url_all'] = false;
		if ($setting[$this->config->get('config_language_id')]['url_all'] != '' && $setting[$this->config->get('config_language_id')]['url_all_text'] != '') {
			$data['url_all'] = '<a href="'.$setting[$this->config->get('config_language_id')]['url_all'].'">'.$setting[$this->config->get('config_language_id')]['url_all_text'].'</a>';
		}
		...
		$data['blog_date_status'] = isset($this->config->get('revblog_settings')['blog_date_status']) && $this->config->get('revblog_settings')['blog_date_status'] ? $this->config->get('revblog_settings')['blog_date_status'] : false;
		$data['category_blog_grid'] = isset($this->config->get('revblog_settings')['category_blog_grid']) && $this->config->get('revblog_settings')['category_blog_grid'] ? $this->config->get('revblog_settings')['category_blog_grid'] : false;
