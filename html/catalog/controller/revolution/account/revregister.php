...
class ControllerRevolutionAccountRevRegister extends Controller {
	...
	public function index() {
		...
		$data['entry_newsletter'] = $this->language->get('entry_rev_newsletter');
		...
		$data['descript'] = isset($settings[$language_id]['revregister_description']) ? html_entity_decode($settings[$language_id]['revregister_description']) : '';
		...
		if ($this->config->get('config_account_id')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree_pol_konf_st_popup'), $this->url->link('information/information', 'information_id=' . $this->config->get('config_account_id'), true), $information_info['title'], $information_info['title']);
			} else {
				$data['text_agree'] = '';
			}
		} else {
