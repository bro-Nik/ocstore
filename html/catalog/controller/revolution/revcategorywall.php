...
class ControllerRevolutionRevcategorywall extends Controller {
    public function index() {
		...
		if ($cache_data) {
			...
			if ($setting['categories'] == 1 && isset($revtheme_home_categorywall_categories) && count($revtheme_home_categorywall_categories)>0) {
			...
			} else if ($setting['categories'] == 2 && isset($revtheme_home_categorywall_manufacturers) && count($revtheme_home_categorywall_manufacturers)>0) {
