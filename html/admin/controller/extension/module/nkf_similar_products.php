...
class ControllerExtensionModuleNkfSimilarProducts extends Controller {
	...
	public function index() {
        ...
        $data['entry_use_excluded_attributes'] = $this->language->get('entry_use_excluded_attributes');
        ...
        if (isset($this->request->post['use_excluded_attributes'])) {
            $data['use_excluded_attributes'] = $this->request->post['use_excluded_attributes'];
        } elseif (!empty($module_info) && isset($module_info['use_excluded_attributes'])) {
            $data['use_excluded_attributes'] = $module_info['use_excluded_attributes'];
        } else {
            $data['use_excluded_attributes'] = 1;
        }
