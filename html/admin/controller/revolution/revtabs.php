...
class ControllerRevolutionRevtabs extends Controller {
	...
	public function add(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('revolution/revtabs', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revtabs', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('revolution/revtabs/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('revolution/revtabs/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['tabss'][] = array(
				...
				'edit'            => $this->url->link('revolution/revtabs/edit', 'user_token=' . $this->session->data['user_token'] . '&tab_id=' . $result['tab_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('revolution/revtabs', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('revolution/revtabs', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('revolution/revtabs', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['tab_id'])) {
			$data['action'] = $this->url->link('revolution/revtabs/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('revolution/revtabs/edit', 'user_token=' . $this->session->data['user_token'] . '&tab_id=' . $this->request->get['tab_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('revolution/revtabs', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		if (isset($this->request->post['tabs_store'])) {
			...
			$data['tabs_store'] = $this->model_revolution_revtabs->getTabsStores($this->request->get['tab_id']);
		} else {
