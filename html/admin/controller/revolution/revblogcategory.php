...
class ControllerRevolutionRevblogCategory extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('revolution/revblogcategory', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revblogcategory', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('revolution/revblogcategory/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('revolution/revblogcategory/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'edit'        		=> $this->url->link('revolution/revblogcategory/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('revolution/revblogcategory', 'user_token=' . $this->session->data['user_token'] . '&sort=cd.title' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('revolution/revblogcategory', 'user_token=' . $this->session->data['user_token'] . '&sort=c.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('revolution/revblogcategory', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('revolution/revblogcategory/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('revolution/revblogcategory/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('revolution/revblogcategory', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
