...
class ModelExtensionModuleNkfSimilarProducts extends Model {
    ...
    public function run() {
        ...
        foreach ($modules as $module) {
            ...
            if (isset($module_info['use_excluded_attributes']) && $module_info['use_excluded_attributes']==0) {
                $anot="";
            } else {
                $anot=" not ";
            }
            ...
            if (isset($module_info['excluded_attributes']) && count($module_info['excluded_attributes']) > 0) {
                $ea = " AND pa.attribute_id ".$anot." in (" . implode(',', $module_info['excluded_attributes']) . ")";
            }
